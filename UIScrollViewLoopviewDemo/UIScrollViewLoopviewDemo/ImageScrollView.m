...
-(ImageScrollView *)initWithFrame:(CGRect)frame ImageArray:(NSArray *)imgArr{
    ...
    if (self) {
        ...
        self.scrollView.contentSize = CGSizeMake(4*[UIScreen mainScreen].bounds.size.width, frame.size.height);
        ...
        for(int i = 0 ; i < 10; i++){
            ...
            imageView.frame = CGRectMake(i*[UIScreen mainScreen].bounds.size.width, 0, [UIScreen mainScreen].bounds.size.width, frame.size.height);
            imageView.tag = i+10;
        ...
        //
        self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width/2-40, frame.size.height-40, 80, 30)];
...
-(void)setImageArray:(NSArray *)imageArray{
    ...
    self.scrollView.contentSize = CGSizeMake(imageArray.count*[UIScreen mainScreen].bounds.size.width, self.frame.size.height);
